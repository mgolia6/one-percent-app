...
const STEPS = [
  ...
  },
  {
    ...
    body: 'Halfway through, you\'ll get a short async form. Ten minutes max. No scheduling, no call — just honest answers on what\'s working and what isn\'t.\n\nThis is how the product gets better. Your feedback is the whole point of the beta.',
    cta: 'I\'LL DO IT →',
    commitment: 'Day 15 check-in — committed.',
  },
  {
    id: 'final',
    eyebrow: 'DAY 30',
    heading: 'One more ask at the end.',
    body: 'At day 30, you\'ll get a final feedback form. And if you want to talk through your experience directly — I\'m available for that.\n\nNo pressure on the call. The form is the real ask. But the offer stands.',
    cta: 'I\'M IN →',
    commitment: 'Day 30 feedback — committed.',
  },
  {
    id: 'name',
    eyebrow: 'LAST THING',
...
export default function OnboardingPage() {
  ...
  return (
    <div style={{
      ...
      {/* Decorative blobs */}
      <div style={{
        position: 'fixed', top: '-15%', right: '-10%', width: 400, height: 400,
        borderRadius: '50%', background: 'radial-gradient(circle, rgba(147,197,235,0.25) 0%, transparent 70%)',
        pointerEvents: 'none',
      }} />
      <div style={{
        position: 'fixed', bottom: '-10%', left: '-5%', width: 300, height: 300,
        borderRadius: '50%', background: 'radial-gradient(circle, rgba(180,210,240,0.2) 0%, transparent 70%)',
        pointerEvents: 'none',
      }} />
      ...
      <div style={{
        ...
        <div style={{ fontSize: 10, letterSpacing: '0.25em', color: 'rgba(26,42,58,0.4)', fontWeight: 500 }}>
          ONE PERCENT
        </div>
      </div>
      ...
      {committed.length > 0 && (
        <div style={{
          ...
          display: 'flex', justifyContent: 'center',
          gap: 8, flexWrap: 'wrap', padding: '0 24px',
        }}>
          {committed.map((c, i) => (
      ...
      {/* Card */}
      <div
        className={`ob-card${animate ? ' visible' : ''}`}
        style={{ width: '100%', maxWidth: 420 }}
      >
        {/* Eyebrow */}
        <div style={{
          fontSize: 9, letterSpacing: '0.2em', color: 'rgba(26,42,58,0.4)',
        ...
        {/* Heading */}
        <div style={{
          fontSize: 26, fontWeight: 400, color: '#1a2a3a',
        ...
        {current.body && (
          <div style={{ marginBottom: 32 }}>
            {current.body.split('\n\n').map((para, i) => (
              <p key={i} style={{
                fontSize: 14, color: 'rgba(26,42,58,0.65)',
                lineHeight: 1.8, marginBottom: i < current.body.split('\n\n').length - 1 ? 14 : 0,
                fontFamily: "'DM Sans', sans-serif",
                fontWeight: 300,
              }}>
                {para}
        ...
        {current.isNameStep && (
          <div style={{ marginBottom: 28 }}>
            ...
            {user?.email && (
              <div style={{
                fontSize: 11, color: 'rgba(26,42,58,0.35)', marginTop: 10,
        ...
        {current.commitment && (
          <div style={{
            marginTop: 14, fontSize: 11, color: 'rgba(26,42,58,0.35)',
            fontFamily: "'DM Mono', monospace", letterSpacing: '0.05em',
            textAlign: 'center',
          }}>
