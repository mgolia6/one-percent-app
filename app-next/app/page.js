...
const ENTRIES = [
  { entry: '001', editionId: 'AI.1', concept: 'Context Window', category: 'AI' },
  { entry: '002', editionId: 'VL.1', concept: 'Framing Effect', category: 'Vocab & Language' },
  { entry: '003', editionId: 'SC.1', concept: 'Discovery Questions', category: 'Sales Craft' },
  ...
  { entry: '006', editionId: 'AI.2', concept: 'Prompt Sensitivity', category: 'AI' },
  { entry: '007', editionId: 'SC.2', concept: 'Talk/Listen Ratio', category: 'Sales Craft' },
  { entry: '008', editionId: 'AI.3', concept: 'Chain-of-Thought Prompting', category: 'AI' },
  { entry: '009', editionId: 'MM.2', concept: 'Survivorship Bias', category: 'Mental Models' },
  { entry: '010', editionId: 'CM.1', concept: 'Feedback That Lands', category: 'Communication' },
  { entry: '011', editionId: 'PH.2', concept: 'Amor Fati', category: 'Philosophy' },
  { entry: '012', editionId: 'CM.2', concept: 'The Ladder of Inference', category: 'Communication' },
  { entry: '013', editionId: 'NC.1', concept: 'Dopamine & Motivation', category: 'Neuroscience & Cognition' },
  { entry: '014', editionId: 'VL.2', concept: 'Euphemism Treadmill', category: 'Vocab & Language' },
  { entry: '015', editionId: 'SC.3', concept: 'Anchoring in Negotiation', category: 'Sales Craft' },
  { entry: '016', editionId: 'MM.3', concept: 'Second-Order Thinking', category: 'Mental Models' },
  { entry: '017', editionId: 'AI.4', concept: 'Hallucination / Confabulation', category: 'AI' },
  { entry: '018', editionId: 'PH.3', concept: 'Dichotomy of Control', category: 'Philosophy' },
  { entry: '019', editionId: 'NC.2', concept: 'Neuroplasticity', category: 'Neuroscience & Cognition' },
  { entry: '020', editionId: 'SC.4', concept: 'Tactical Empathy', category: 'Sales Craft' },
  { entry: '021', editionId: 'CM.3', concept: 'Active Listening', category: 'Communication' },
  { entry: '022', editionId: 'SC.5', concept: 'Multi-Threading', category: 'Sales Craft' },
  { entry: '023', editionId: 'AI.5', concept: 'RAG (Retrieval-Augmented Generation)', category: 'AI' },
  { entry: '024', editionId: 'VL.3', concept: 'Nominalization', category: 'Vocab & Language' },
  { entry: '025', editionId: 'NC.3', concept: 'Meditation and the Brain', category: 'Neuroscience & Cognition' },
  { entry: '026', editionId: 'SC.6', concept: 'Mirroring', category: 'Sales Craft' },
  { entry: '027', editionId: 'AI.6', concept: 'AI Agents', category: 'AI' },
  { entry: '028', editionId: 'VL.4', concept: 'Loaded Language', category: 'Vocab & Language' },
  { entry: '029', editionId: 'SC.7', concept: 'Labeling', category: 'Sales Craft' },
  ...
  { entry: '034', editionId: 'SC.8', concept: 'Calibrated Questions', category: 'Sales Craft' },
  { entry: '035', editionId: 'AI.7', concept: 'System Prompts', category: 'AI' },
  { entry: '036', editionId: 'VL.5', concept: 'The Overton Window', category: 'Vocab & Language' },
  { entry: '037', editionId: 'SC.9', concept: 'The Accusation Audit', category: 'Sales Craft' },
  { entry: '038', editionId: 'MM.5', concept: 'First Principles Thinking', category: 'Mental Models' },
  { entry: '039', editionId: 'AI.8', concept: 'Temperature & Sampling', category: 'AI' },
...
export default function HomePage() {
  ...
  if (loading) return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#0e141c' }}>
      <div style={{ display: 'flex', gap: 5 }}>
        {[0,1,2].map(i => <div key={i} style={{ width: 5, height: 5, borderRadius: '50%', background: 'rgba(232,238,245,0.6)', animation: `pulse 1.2s ease-in-out ${i * 0.2}s infinite`, opacity: 0.4 }} />)}
    ...
    <div style={S.page}>
      ...
      {activeTab === 'today' && (
        ...
        <div style={S.screen}>
          ...
          {/* On This Day — daily bonus card (live for all users) */}
          <OnThisDay />
