...
const THEMES = {
  morning: {
    bg: 'linear-gradient(160deg, #1e2535 0%, #1a2030 50%, #161c2a 100%)',
    bgSolid: '#1a2030',
    surface: 'rgba(255,255,255,0.06)',
    surfaceBorder: 'rgba(232,238,245,0.08)',
    text: '#e8eef5',
    textMid: 'rgba(232,238,245,0.65)',
    textDim: 'rgba(232,238,245,0.35)',
    textFaint: 'rgba(232,238,245,0.18)',
    border: 'rgba(232,238,245,0.08)',
    borderMid: 'rgba(232,238,245,0.12)',
    headerBg: 'rgba(30,37,53,0.92)',
