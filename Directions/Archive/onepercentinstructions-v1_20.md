...
**Version 1.20 | Updated May 20, 2026**
...
- **Feedback tab:** Aggregated by entry number — avg Topic/Content/Quiz as visual bar, comments collected. Weekly check-ins and anytime feedback in separate sections below.
- **Bugs tab:** All bug reports
- **Users tab:** All users with RESET USER DATA button (two-step confirm — clears completions, feedback, resets streak)
