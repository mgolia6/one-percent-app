...
**Version 1.24 | Updated May 20, 2026**
...
| v1.24 | 2026-05-20 | Changelog workflow added. About + Changelog pages added to app. Enhancement backlog seeded. Bug status column added. Action bar redesigned (dark pill). Tab system redesigned (dark pill, no float). Badge visibility fixed. Gap between nav and stats reduced. |
...
└── app-next/
    ...
    │   ├── entry/[id]/page.js
    │   ├── admin/page.js
    │   ├── about/page.js          — About page (added v1.24)
    │   ├── changelog/page.js      — Changelog page (added v1.24)
    │   ├── login/page.js
    │   ├── onboarding/page.js
    │   └── profile/page.js
...
### Supabase Schema (current, as of v1.24)

**profiles:** `id`, `email`, `name`, `first_name`, `last_name`, `signup_date`, `current_streak`, `longest_streak`, `last_active_date`, `onboarding_complete`, `is_admin`, `avatar_url`
...
### Library Page Design (as of v1.24)
...
### Changelog Workflow (added v1.24)
