...
### Concept selection
- Initial candidate: Loaded Language (VL.3)
- Rejected: Euphemism Treadmill overlap too heavy (restructuring/rightsizing examples live in both concepts; corporate softening angle is ET's home turf)
- Pitched alternatives: Overton Window, Code-Switching, Semantic Satiation, Nominalization
- Selected: Nominalization — no ET overlap (mechanism is about erasing actors, not softening outcomes), strong sourcing, immediate practical application

### Sources
1. Orwell, "Politics and the English Language," Horizon, April 1946 — primary anchor, quote verified at orwellfoundation.com
2. Williams, Style: Ten Lessons in Clarity and Grace, 1981 — secondary, cited not quoted
3. Organization Science AI Task Force — 6,957 submissions analyzed Jan 2021–Feb 2026 — In the Wild Type A, nominalization increase in AI-assisted papers documented

### Files committed
- `app-next/public/entries/019.json`
- `app-next/app/page.js` (TOTAL_ENTRIES 18→19, entry added)
- `Verify/onepercentverify2026-05-21-vocablanguage-nominalization.md`
- `Backlog/onepercentbacklog.md` (Nominalization marked used, next updated to SC slot 4)
...
## Entry Manifest (current — 19 entries)
...
**Entry 020 — SC (Sales Craft, slot 4)**
Rotation: SC → AI → VL → **SC** → MM → AI → PH → NC → CM
Candidates: Mirroring, Labeling, Calibrated Questions (Black Swan/Voss series)

---

## Outstanding Items

- Entry 017 verify audit (Jahic quote wording — "about themselves" vs "themselves")
- LinkedIn carousel for Entry 017
- ISSUE-002 — Weekly feedback trigger for backdated signups
- ISSUE-003 — Multi-threading bug (not yet investigated)
- ISSUE-005 — Onboarding text overlap on mobile
